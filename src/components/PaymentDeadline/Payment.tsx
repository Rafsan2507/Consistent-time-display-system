          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="text-sm px-3 py-1">
                Date and Time in UTC : {sampleOrders[0].paymentDeadline}
              </Badge>
            </div>
          </CardContent>
        </Card>
        ...
        <Tabs value={status} onValueChange={setStatus} className="w-full">
            ...
            <Card className="shadow-lg border-0">
              <CardHeader className="bg-slate-50 border-b">
                <CardTitle className="text-xl text-slate-700 flex items-center gap-2">
                  Payment Deadline in Multiple Timezone - Inconsistent
                </CardTitle>
                <CardDescription>Uses System's Timezone</CardDescription>
              </CardHeader>
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="text-lg font-semibold text-slate-800">
                          {displayTimeInTimezone(
                            sampleOrders[0].paymentDeadline,
                            tz.value
                          )}
                        </div>
          ...
          <TabsContent value="after">
            <Card className="shadow-lg border-0">
              <CardHeader className="bg-slate-50 border-b">
                <CardTitle className="text-xl text-slate-700 flex items-center gap-2">
                  Payment Deadline in Business Timezone - Consistent
                </CardTitle>
                <CardDescription>
